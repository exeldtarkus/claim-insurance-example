...
const CablePlug404 = () => {
  const animationData = useLottieAnimation("404/Animation-404-plug.json");
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4 bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100 transition-colors">
      ...
      <h2 className="text-xl font-semibold mt-4">Looks like the connection’s lost...</h2>
